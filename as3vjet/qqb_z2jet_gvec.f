...
c in is the label of the contracted line
      ...
      real(dp):: fac,n(4)
!     complex(dp):: prop,zab(as3vj_mxpart,as3vj_mxpart),zba(as3vj_mxpart,as3vj_mxpart)
      complex(dp):: prop,zab(6,6),zba(6,6)
      real(dp):: msqv(-nf:nf,-nf:nf),p(as3vj_mxpart,4),ggtemp(0:2),
