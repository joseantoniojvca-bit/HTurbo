...
#pragma omp threadprivate(mesqij,mesqij_NFZ)
  ...
  // Specific declarations for Interference and Signal
  // LEAN
  complex<double> LO_MggH(double s12);
  complex<double> LO_MHyy(double s12);
  double LO_Mggyy(double s, double t, double u);
  complex<double> amp_MggHyy(double s, double t, double u);
  double _amp_MggHyy(double s, double t, double u);
  complex<double> CorcheteMartin(double ss);
  complex<double> SumaMartin(double ss);
  double LQ(double costh1);
  complex<double> ff( double xx);
  complex<double> F1( double xx);
  complex<double> F1on2( double xx);
