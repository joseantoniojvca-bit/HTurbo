...
#pragma omp threadprivate(fn1,fn2)
  ...
  //photon PDF
  extern complex <double> *fotx1;
  extern complex <double> *fotx2;
#pragma omp threadprivate(fotx1,fotx2)
    
  extern complex <double> fotn1;
  extern complex <double> fotn2;
#pragma omp threadprivate(fotn1,fotn2)
  
  //scales
  extern complex <double> bbb;
...
#pragma omp threadprivate(bbb,bstar,mub_a,mub,mubstar_a,mubstar,mubstartilde)

  //alphas for the evolution
  extern complex <double> logasl, asl;
  extern complex <double> logasl_b, asl_b;
  extern complex <double> logasl_c, asl_c;
#pragma omp threadprivate(logasl,asl,logasl_b,asl_b,logasl_c,asl_c)

  //alphaqed for the evolution
  extern complex <double> logaqedl, aqedl;
#pragma omp threadprivate(logaqedl,aqedl)
...
#pragma omp threadprivate(bscale,bstarscale,bstartilde,qbstar,bcomplex)
  ...
  //qed evolution
  extern void alphaqedl(complex <double> b);
  ...
  //HF versions
  extern void storemoments_b(int i, int sign, complex <double> fx[11]);
  extern void storemoments_c(int i, int sign, complex <double> fx[11]);
  ...
  extern void retrieve1d_neg(int i);
  ...
  extern void retrievemuf(int i, int j, int sign);
