...
double resintegrand0d()
{
  double res = 0.;
  if (opts.cubacores == 0)
    {
      for (unsigned i = 0; i < opts.mrule; i++)
	{
	  double x[1] = {0.5+0.5*gr::xxx[opts.mrule-1][i]};
	  double f[1];
	  resintegrand1d(1, x, 1, f);
	  res += 0.5 * gr::www[opts.mrule-1][i] * f[0];
	}
      return res;
    }
...
#pragma omp parallel for reduction(+:res) num_threads(opts.cubacores)	\
  copyin(a_param_,rlogs_,resint::a,resint::loga,resint::rloga,		\
	 ...
	 evoltrunc::gli,evoltrunc::vai,evoltrunc::m3i,evoltrunc::m8i,evoltrunc::m15i,evoltrunc::m24i,evoltrunc::sgi,evoltrunc::p3i,evoltrunc::p8i,evoltrunc::p15i,evoltrunc::p24i,evoltrunc::cxn,evoltrunc::gli_muf,evoltrunc::vai_muf,evoltrunc::m3i_muf,evoltrunc::m8i_muf,evoltrunc::m15i_muf,evoltrunc::m24i_muf,evoltrunc::sgi_muf,evoltrunc::p3i_muf,evoltrunc::p8i_muf,evoltrunc::p15i_muf,evoltrunc::p24i_muf,evoltrunc::rp,evoltrunc::rm,evoltrunc::Ep,evoltrunc::Em,evoltrunc::U1,evoltrunc::U2,evoltrunc::U3,evoltrunc::U,evoltrunc::R0NS,evoltrunc::U1NSp,evoltrunc::U1NSm,evoltrunc::U1NSv,evoltrunc::U2NSp,evoltrunc::U2NSm,evoltrunc::U2NSv,evoltrunc::U3NSp,evoltrunc::U3NSm,evoltrunc::U3NSv,evoltrunc::UNSp,evoltrunc::UNSm,evoltrunc::UNSv,\
	 pmom::gamma1qq,pmom::gamma1qqb,pmom::gamma1qqp,pmom::gamma1qqbp,pmom::gamma1qg,pmom::gamma1gq,pmom::gamma1gg,pmom::gamma2qq,pmom::gamma2qqb,pmom::gamma2qqp,pmom::gamma2qqbp,pmom::gamma2qg,pmom::gamma2gq,pmom::gamma2gg,pmom::gamma3qq,pmom::gamma3qqb,pmom::gamma3qqp,pmom::gamma3qqbp,pmom::gamma3qg,pmom::gamma3gq,pmom::gamma3gg,pmom::gamma4qq,pmom::gamma4qqb,pmom::gamma4qqp,pmom::gamma4qqbp,pmom::gamma4qg,pmom::gamma4gq,pmom::gamma4gg,\
	 pmom::gamma1qq_1,pmom::gamma1qqb_1,pmom::gamma1qqp_1,pmom::gamma1qqbp_1,pmom::gamma1qg_1,pmom::gamma1gq_1,pmom::gamma1gg_1,pmom::gamma2qq_1,pmom::gamma2qqb_1,pmom::gamma2qqp_1,pmom::gamma2qqbp_1,pmom::gamma2qg_1,pmom::gamma2gq_1,pmom::gamma2gg_1,pmom::gamma3qq_1,pmom::gamma3qqb_1,pmom::gamma3qqp_1,pmom::gamma3qqbp_1,pmom::gamma3qg_1,pmom::gamma3gq_1,pmom::gamma3gg_1,pmom::gamma4qq_1,pmom::gamma4qqb_1,pmom::gamma4qqp_1,pmom::gamma4qqbp_1,pmom::gamma4qg_1,pmom::gamma4gq_1,pmom::gamma4gg_1,\
	 pmom::gamma1qq_2,pmom::gamma1qqb_2,pmom::gamma1qqp_2,pmom::gamma1qqbp_2,pmom::gamma1qg_2,pmom::gamma1gq_2,pmom::gamma1gg_2,pmom::gamma2qq_2,pmom::gamma2qqb_2,pmom::gamma2qqp_2,pmom::gamma2qqbp_2,pmom::gamma2qg_2,pmom::gamma2gq_2,pmom::gamma2gg_2,pmom::gamma3qq_2,pmom::gamma3qqb_2,pmom::gamma3qqp_2,pmom::gamma3qqbp_2,pmom::gamma3qg_2,pmom::gamma3gq_2,pmom::gamma3gg_2,pmom::gamma4qq_2,pmom::gamma4qqb_2,pmom::gamma4qqp_2,pmom::gamma4qqbp_2,pmom::gamma4qg_2,pmom::gamma4gq_2,pmom::gamma4gg_2)
    for (unsigned i = 0; i < opts.mrule; i++)
      {
	// evaluate the integrand for npts points
	double x[1];
	double f[1];
	x[0] = 0.5+0.5*gr::xxx[opts.mrule-1][i];
	resintegrand1d(1, x, 1, f);
	res += 0.5 * gr::www[opts.mrule-1][i] * f[0];
      }
  ...
  if (opts.threading == 1)
    {
      ...
      if (pipe(fd) < 0)
	{
	  cout << "Error in resintegrand0d fork/wait: could not create pipe" << endl;
	  exit(-1);
	}
	  ...
	  if (id == 0)
	    {
	      ...
	      x[0] = 0.5+0.5*gr::xxx[opts.mrule-1][i];
	      resintegrand1d(1, x, 1, f);
	      double partres = 0.5 * gr::www[opts.mrule-1][i] * f[0];
	      write(fd[1], &partres, sizeof partres);
	      exit(0);
	    }
	  else if (id < 0)
	    {
	      cout << "Error in resintegrand0d fork failed for process " << i << " pid " << id << endl;
	      exit (-1);
	    }
	}
      ...
      for(int i = 0; i < opts.mrule; i++)
	{
	  ...
	  if (nbytes > 0)
	    ...
	    {
	      cout << "Error in resintegrand0d fork/wait: nothing on the pipe" << endl;
	      exit(-1);
	    }
	}
...
integrand_t resintegrandMCsmearing(const int &ndim, const double x[], const int &ncomp, double f[],
                                   ...
                                   double &weight, const int &iter)
{
  ...
  double r[4] = {x[0], x[1], x[2],x[6]};
  status = phasespace::gen_myqts(r, jac, false, true); //(qtcut = false, qtswitching = true)
  if (!status)
  { cout << " status " << endl;
    f[0] = 0.;
    return 0;
...
*/
  ...
  if (opts.helicity >= 0)
  {
    if(opts.calc_type == "OLD")
      ...
      f[1] = f[1]*jac/8./M_PI*swtch;
  }

  if (iter==cubacall::last_iter)
  {
...
integrand_t resintegrand1d(const int &ndim, const double x[], const int &ncomp, double f[])
{
  ...
  //Include qt in the kinematic limit in y
  if (opts.qtlim)
  {
    double qt2 = pow(phasespace::qtmax,2);
    double mt2 = phasespace::m2+qt2;
    double mt = sqrt(mt2);
    double tmpx=(phasespace::m2+pow(opts.sroot,2))/opts.sroot/mt;
    ylim=log((tmpx+sqrt(max(0.,pow(tmpx,2)-4.)))/2.); //Limit y boundaries to the kinematic limit in y --> introduced max to avoid neqative argument of sqrt
  }
  ...
  if (opts.dsdxf)
    {
      //Set an average qt in case qt is to be used in calculating xF
      double qt = 0.5*(phasespace::qtmax+phasespace::qtmin);
      phasespace::set_qt(qt);
      phasespace::set_xf_bounds(ymn, ymx);
    }
...
#pragma omp parallel for num_threads(opts.cubacores) \
  copyin(a_param_,rlogs_,resint::a,resint::loga,resint::rloga,\
	 ...
	 pmom::gamma1qq_1,pmom::gamma1qqb_1,pmom::gamma1qqp_1,pmom::gamma1qqbp_1,pmom::gamma1qg_1,pmom::gamma1gq_1,pmom::gamma1gg_1,pmom::gamma2qq_1,pmom::gamma2qqb_1,pmom::gamma2qqp_1,pmom::gamma2qqbp_1,pmom::gamma2qg_1,pmom::gamma2gq_1,pmom::gamma2gg_1,pmom::gamma3qq_1,pmom::gamma3qqb_1,pmom::gamma3qqp_1,pmom::gamma3qqbp_1,pmom::gamma3qg_1,pmom::gamma3gq_1,pmom::gamma3gg_1,pmom::gamma4qq_1,pmom::gamma4qqb_1,pmom::gamma4qqp_1,pmom::gamma4qqbp_1,pmom::gamma4qg_1,pmom::gamma4gq_1,pmom::gamma4gg_1,\
	 pmom::gamma1qq_2,pmom::gamma1qqb_2,pmom::gamma1qqp_2,pmom::gamma1qqbp_2,pmom::gamma1qg_2,pmom::gamma1gq_2,pmom::gamma1gg_2,pmom::gamma2qq_2,pmom::gamma2qqb_2,pmom::gamma2qqp_2,pmom::gamma2qqbp_2,pmom::gamma2qg_2,pmom::gamma2gq_2,pmom::gamma2gg_2,pmom::gamma3qq_2,pmom::gamma3qqb_2,pmom::gamma3qqp_2,pmom::gamma3qqbp_2,pmom::gamma3qg_2,pmom::gamma3gq_2,pmom::gamma3gg_2,pmom::gamma4qq_2,pmom::gamma4qqb_2,pmom::gamma4qqp_2,pmom::gamma4qqbp_2,pmom::gamma4qg_2,pmom::gamma4gq_2,pmom::gamma4gg_2)
  //  copyin(a_param_,rlogs_,resint::a,resint::loga,resint::rloga,evolnative::UVP,evolnative::DVP,evolnative::USP,evolnative::DSP,evolnative::SSP,evolnative::GLP,evolnative::CHP,evolnative::BOP,evolnative::SIP,evolnative::NS3P,evolnative::NS8P,evolnative::NS15P,evolnative::NS24P,evolnative::NS35P,order_,painp_,hfpainp_)
