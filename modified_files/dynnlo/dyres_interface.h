...
extern "C"
{
  ...
  // Higgs production
  double  pggreg_(double& z);
  double  pgq_(double& z);
  double  cgg_(double& z);
  double  cgq_(double& z);
  double  pggggreg_(double& z);
  double  pgggq_(double& z);
  double  pgqqq_(double& z);
  double  pgqqg_(double& z);
  double  cgqpqg_(double& z);
  double  cgqpqq_(double& z);
  double  p2gg_(double& x);
  double  p2gq_(double& x);
