...
!      include 'first.f'
      include 'ppwp2j.f'
      include 'blha.f'
      real(dp):: msq(-nf:nf,-nf:nf),p(as3vj_mxpart,4),
...
c--- set up spinors
!     call as3vj_spinoru(6,p,za,zb)
      call mcfm_spinoru(6,p,za,zb)
...
c--- calculate 2-quark, 2-gluon amplitudes
      if (Gflag) then
        call as3vj_w2jetsq(1,2,3,4,5,6,za,zb,qqbWgg2)
        call storecs(qqbWgg2_cs)
        call as3vj_w2jetsq(2,1,3,4,5,6,za,zb,qbqWgg2)
        call storecs(qbqWgg2_cs)
        call as3vj_w2jetsq(1,5,3,4,2,6,za,zb,qgWqg2)
        call storecs(qgWqg2_cs)
        call as3vj_w2jetsq(2,5,3,4,1,6,za,zb,gqWqg2)
        call storecs(gqWqg2_cs)
        call as3vj_w2jetsq(5,1,3,4,2,6,za,zb,qbgWqbg2)
        call storecs(qbgWqbg2_cs)
        call as3vj_w2jetsq(5,2,3,4,1,6,za,zb,gqbWqbg2)
        call storecs(gqbWqbg2_cs)
        call as3vj_w2jetsq(5,6,3,4,1,2,za,zb,ggWqbq2)
        call storecs(ggWqbq2_cs)
        call as3vj_w2jetsq(6,5,3,4,1,2,za,zb,ggWqqb2)
        call storecs(ggWqqb2_cs)
        call as3vj_w2jetsq(2,6,3,4,1,5,za,zb,gqWgq2)
        call storecs(gqWgq2_cs)
        call as3vj_w2jetsq(6,2,3,4,1,5,za,zb,gqbWgqb2)
        call storecs(gqbWgqb2_cs)
        call as3vj_w2jetsq(1,6,3,4,2,5,za,zb,qgWgq2)
        call storecs(qgWgq2_cs)
        call as3vj_w2jetsq(6,1,3,4,2,5,za,zb,qbgWgqb2)
...
c---                and q qb --> g* --> q (--> W q) qb (amps 2 and 4)
        call as3vj_amp_q_QbQ_qb(1,2,5,6,qqb1(1),qqb2(1),qqb3(1),qqb4(1))
c--- crossed - q qb --> q qb ( --> W qb)
c        call as3vj_amp_q_QbQ_qb(1,5,2,6,qqb1(2),qqb2(2),qqb3(2),qqb4(2))
c--- crossed - q qb --> q ( --> W q) qb
c        call as3vj_amp_q_QbQ_qb(6,2,5,1,qqb1(3),qqb2(3),qqb3(3),qqb4(3))
c--- NEW: ADDED 7/17/01
        call as3vj_amp_q_QbQ_qb(1,2,6,5,qqb1(4),qqb2(4),qqb3(4),qqb4(4))
c        call as3vj_amp_q_QbQ_qb(1,6,2,5,qqb1(5),qqb2(5),qqb3(5),qqb4(5))
c        call as3vj_amp_q_QbQ_qb(5,2,6,1,qqb1(6),qqb2(6),qqb3(6),qqb4(6))

c--- now the qb q amplitudes
        call as3vj_amp_q_QbQ_qb(2,1,5,6,qbq1(1),qbq2(1),qbq3(1),qbq4(1))
c--- crossed - qb q --> qb q ( --> W q)
        call as3vj_amp_q_QbQ_qb(2,5,1,6,qbq1(2),qbq2(2),qbq3(2),qbq4(2))
c--- crossed - qb q --> qb ( --> W qb) q
c        call as3vj_amp_q_QbQ_qb(6,1,5,2,qbq1(3),qbq2(3),qbq3(3),qbq4(3))
c--- NEW: ADDED 7/17/01
c        call as3vj_amp_q_QbQ_qb(2,1,6,5,qbq1(4),qbq2(4),qbq3(4),qbq4(4))
c        call as3vj_amp_q_QbQ_qb(2,6,1,5,qbq1(5),qbq2(5),qbq3(5),qbq4(5))
c        call as3vj_amp_q_QbQ_qb(5,1,6,2,qbq1(6),qbq2(6),qbq3(6),qbq4(6))

c--- crossed q q --> q ( --> W q) q
        call as3vj_amp_q_QbQ_qb(1,5,6,2,qq1(1),qq2(1),qq3(1),qq4(1))
c--- crossed q q --> q q ( --> W q)
        call as3vj_amp_q_QbQ_qb(2,5,6,1,qq1(2),qq2(2),qq3(2),qq4(2))
c--- crossed q q --> q q ( --> W q)
c        call as3vj_amp_q_QbQ_qb(2,6,5,1,qq1(3),qq2(3),qq3(3),qq4(3))
c--- crossed q q --> q ( --> W q) q
c        call as3vj_amp_q_QbQ_qb(1,6,5,2,qq1(4),qq2(4),qq3(4),qq4(4))

c--- crossed qb qb --> qb ( --> W qb) qb
        call as3vj_amp_q_QbQ_qb(5,1,2,6,qbqb1(1),qbqb2(1),qbqb3(1),qbqb4(1))
c--- crossed qb qb --> qb qb ( --> W qb)
        call as3vj_amp_q_QbQ_qb(5,2,1,6,qbqb1(2),qbqb2(2),qbqb3(2),qbqb4(2))
c--- crossed qb qb --> qb ( --> W qb) qb
c        call as3vj_amp_q_QbQ_qb(6,2,1,5,qbqb1(3),qbqb2(3),qbqb3(3),qbqb4(3))
c--- crossed qb qb --> qb qb ( --> W qb)
c        call as3vj_amp_q_QbQ_qb(6,1,2,5,qbqb1(4),qbqb2(4),qbqb3(4),qbqb4(4))
